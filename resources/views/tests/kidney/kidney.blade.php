            ...
            <div class="container-fluid">
            	<div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="{{ route('add_kidney')}}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Kidney Tests</a>
                    </div>
                    @endif
                </div>
                <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table id="bootstrap-data-table-export3" class="display nowrap table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$kidney->pgender}}</td>
                                            <td>{{$kidney->pnumber}}</td>
                                            <td>{{$kidney->pemail}}</td>
                                            <td>{{$kidney->count}}</td>
                                            <td>
                                                
                                                    <a href="{{ route('view_kidney', ['id' => $kidney->id] ) }}" class="btn btn-sm btn-success btn-round">View</a> 

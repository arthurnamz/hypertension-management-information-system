...
@section('content')
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Add Chest Test</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form method="POST" action="{{ route('store_chest')}}"  enctype="multipart/form-data" >
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Create Chest Test</button>
                            </div>
                        </form>
                    </div>
                </div>

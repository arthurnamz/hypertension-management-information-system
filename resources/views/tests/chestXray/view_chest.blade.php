            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="{{ route('chest_test')}}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-refresh"></i> Chest X-ray Tests</a>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table id="bootstrap-data-table-export3" class="display nowrap table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action=" {{ route('delete_chest', $chest->id)}}" enctype="multipart/form-data">
                                                         @csrf
                                                    
                                                    <a href="{{ route('edit_chest', ['id' => $chest->id] ) }}" class="btn btn-sm btn-info btn-round">Edit</a>
   ...
   <!--  <script src="js/datatables/datatables-init.js"></script> -->
    <script type="text/javascript">
        ...
        buttons: [
           {
                extend: 'copyHtml5',
                title: 'Chest X-ray Test List',
                filename: 'Chest X-ray Test List',
                exportOptions: {
                    columns: [ 0, 1 ,2, 3 ,4  ]
                }
            }, {

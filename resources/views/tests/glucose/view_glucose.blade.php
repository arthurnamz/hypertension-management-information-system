            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="{{ route('glucose_test')}}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-refresh"></i> Glucose Tests</a>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table id="bootstrap-data-table-export3" class="display nowrap table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action=" {{ route('delete_glucose', $glucose->id)}}" enctype="multipart/form-data">
                                                         @csrf
                                                    
                                                    <a href="{{ route('edit_glucose', ['id' => $glucose->id] ) }}" class="btn btn-sm btn-info btn-round">Edit</a>

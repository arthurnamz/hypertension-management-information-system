            ...
            <div class="container-fluid">
            	<div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="{{ route('add_other')}}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Other Tests</a>
                    </div>
                    @endif
                </div>
                <div class="row">
                                    ...
                                    <table id="bootstrap-data-table-export3" class="display nowrap table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    <a href="{{ route('view_other', ['id' => $other->id] ) }}" class="btn btn-sm btn-success btn-round">View</a> 
   ...
   <!--  <script src="js/datatables/datatables-init.js"></script> -->
    <script type="text/javascript">
        ...
        buttons: [
           {
                extend: 'copyHtml5',
                title: 'Other Tests List',
                filename: 'Other Tests List',
                exportOptions: {
                    columns: [ 0, 1 ,2, 3 ,4  ]
                }
            }, {

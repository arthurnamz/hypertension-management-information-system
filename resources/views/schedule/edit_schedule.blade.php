                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form method="POST" action="{{ route('update_schedule', $Schedule->id)}}"  enctype="multipart/form-data" >
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select" name="employee_id">
                                            <option value="{{$Schedule->employee_id}}">{{$Schedule->Employee->first_name}} {{$Schedule->Employee->last_name}}</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select"  name="available_days">
                                            <option value="{{$Schedule->available_days}}">{{$Schedule->available_days}} </option>
                            ...
                            <div class="form-group">
                                <label>Message</label>
                                <textarea cols="30" rows="4" name="message" class="form-control">{{$Schedule->message}}</textarea>
                            </div>
                            <div class="form-group">
